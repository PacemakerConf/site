...
RSpec.describe Admin::ConfigurationsController, type: :controller do
  ...
  # Admin::Configuration. As you add validations to Admin::Configuration, be sure to
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested admin_configuration" do
        configuration = Admin::Configuration.create! valid_attributes
        put :update, {:id => configuration.to_param, :admin_configuration => new_attributes}, valid_session
      ...
      it "assigns the requested admin_configuration as @admin_configuration" do
        configuration = Admin::Configuration.create! valid_attributes
        put :update, {:id => configuration.to_param, :admin_configuration => valid_attributes}, valid_session
        expect(assigns(:admin_configuration)).to eq(configuration)
      end

      it "redirects to the admin_configuration" do
        configuration = Admin::Configuration.create! valid_attributes
        put :update, {:id => configuration.to_param, :admin_configuration => valid_attributes}, valid_session
    ...
    context "with invalid params" do
      it "assigns the admin_configuration as @admin_configuration" do
        configuration = Admin::Configuration.create! valid_attributes
        put :update, {:id => configuration.to_param, :admin_configuration => invalid_attributes}, valid_session
        expect(assigns(:admin_configuration)).to eq(configuration)
      end
