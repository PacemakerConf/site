...
RSpec.describe ConferenceController, :type => :controller do
  ...
  # ConferenceController. Be sure to keep this updated too.
  let(:valid_session) { {} }

  describe "GET index" do
    it "assigns all conferences as @conferences" do
      conferences = conferences.create! valid_attributes
      get :index, {}, valid_session
      expect(assigns(:conferences)).to eq([conferences])
    end
  end

  describe "GET show" do
    it "assigns the requested conferences as @conferences" do
      conferences = conferences.create! valid_attributes
      get :show, {:id => conferences.to_param}, valid_session
      expect(assigns(:conferences)).to eq(conferences)
    end
  end

  describe "GET new" do
    it "assigns a new conferences as @conferences" do
      get :new, {}, valid_session
      expect(assigns(:conferences)).to be_a_new(conferences)
    end
  end

  describe "GET edit" do
    it "assigns the requested conferences as @year" do
