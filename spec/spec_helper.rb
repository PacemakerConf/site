...
spec_helper_setup = proc do
  ...
  RSpec.configure do |config|
    ...
    config.include Devise::TestHelpers, type: :controller    # Run specs in random order to surface order dependencies. If you find an
...
require 'spork' if ENV["RAILS_ENV"] == 'test'
