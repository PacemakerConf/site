...
class EventTypesControllerTest < ActionController::TestCase
  ...
  test "should create event_type" do
    assert_difference('EventType.count') do
      post :create, event_type: { color: @event_type.color, defaultDuration: @event_type.defaultDuration, description: @event_type.description, image: @event_type.image, name: @event_type.name, speakerEvent: @event_type.speakerEvent }
    end
  ...
  test "should update event_type" do
    patch :update, id: @event_type, event_type: { color: @event_type.color, defaultDuration: @event_type.defaultDuration, description: @event_type.description, image: @event_type.image, name: @event_type.name, speakerEvent: @event_type.speakerEvent }
    assert_redirected_to event_type_path(assigns(:event_type))
  end
